...
<a href="http://codemirror.net/" target="_blank">CodeMirror 5.11.0</a> packaged for Meteor. **CodeMirror** is a versatile text editor implemented in JavaScript for the browser.
